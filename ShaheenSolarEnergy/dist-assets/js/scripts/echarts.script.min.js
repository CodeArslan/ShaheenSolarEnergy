...
$(document).ready(function () {
    var e, t, o, i, a, n, r, l, s, c, d, m, h, f, y, b, p, u, w = document.getElementById("echartBar"),
        w = (w && ((e = echarts.init(w)).setOption({
            legend: {
                borderRadius: 0,
                orient: "horizontal",
                x: "right",
        ...
        })), document.getElementById("echartPie")),
        w = (w && ((t = echarts.init(w)).setOption({
        ...
        })), document.getElementById("basicLine")),
        w = (w && ((o = echarts.init(w)).setOption({
            tooltip: {
                show: !0,
                trigger: "axis",
                axisPointer: {
        ...
        w = (w && ((i = echarts.init(w)).setOption({
            tooltip: {
                trigger: "axis"
            },
            grid: {
        ...
        })), document.getElementById("basicBar")),
        w = (w && ((a = echarts.init(w)).setOption({
            grid: {
                show: !1,
                top: 5,
                left: 0,
        ...
        })), document.getElementById("multipleBar")),
        w = (w && ((n = echarts.init(w)).setOption({
            grid: {
                show: !1,
                left: "3%",
                right: "4%",
        ...
        })), document.getElementById("multipleBar2")),
        w = (w && ((r = echarts.init(w)).setOption({
            tooltip: {
                trigger: "axis",
                axisPointer: {
                    type: "shadow"
        ...
        w = (w && ((l = echarts.init(w)).setOption({
            tooltip: {
                trigger: "axis",
                axisPointer: {
                    type: "shadow",
        ...
        })), document.getElementById("basicDoughnut")),
        w = (w && ((s = echarts.init(w)).setOption({
            grid: {
                left: "3%",
                right: "4%",
                bottom: "3%",
        ...
        })), document.getElementById("basicArea")),
        w = (w && ((c = echarts.init(w)).setOption({
            tooltip: {
                trigger: "axis",
                axisPointer: {
                    animation: !0
        ...
        })), document.getElementById("stackedArea")),
        w = (w && ((d = echarts.init(w)).setOption({
            tooltip: {
                trigger: "axis",
                axisPointer: {
                    animation: !0
        ...
        })), document.getElementById("stackedPointerArea")),
        w = (w && ((m = echarts.init(w)).setOption({
            tooltip: {
                trigger: "axis",
                axisPointer: {
                    animation: !0
        ...
        })), document.getElementById("solidArea")),
        w = (w && ((h = echarts.init(w)).setOption({
            tooltip: {
                show: !0,
                trigger: "axis"
            },
        ...
        })), document.getElementById("basicPie")),
        w = (w && ((f = echarts.init(w)).setOption({
        ...
        })), document.getElementById("stackedPie")),
        w = (w && ((y = echarts.init(w)).setOption({
            grid: {
                left: "3%",
                right: "4%",
                bottom: "3%",
        ...
        w = (w && ((b = echarts.init(w)).setOption({
            grid: {
                left: "3%",
                right: "4%",
                bottom: "3%",
    ...
    w && (p = echarts.init(w), u = {
        ...
        u.series[0].data[0].value = +(100 * Math.random()).toFixed(2), p.setOption(u, !0)
